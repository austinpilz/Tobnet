...
public class SandFallArenaSetupSession extends SetupSession {
  ...
  protected void configureSteps() {
    ...
    CustomSetupSessionStepExample customStep =
      new CustomSetupSessionStepExample(3, this);
  ...
  protected void onSessionComplete(SetupSessionStepInvocationContext context) {
    ...
    CustomSetupSessionStepExample customStep =
      (CustomSetupSessionStepExample) getStepByName("custom-example-name")
        .get();
    ...
    TobnetChatUtils.sendPlayerMessage(
      context.getPlayer(),
      "The custom message you entered was " +
      SetupSessionChatUtils.generateColoredChatSegment(
        customStep.getCustomMessage(),
