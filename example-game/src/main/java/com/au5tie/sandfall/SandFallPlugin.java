...
public class SandFallPlugin extends TobnetGamePlugin {
    ...
    public final static String gameCommand = "sf";
     ...
     * class. If a user goes through the setup session process and provides the type as "arena", the setup session controlller
