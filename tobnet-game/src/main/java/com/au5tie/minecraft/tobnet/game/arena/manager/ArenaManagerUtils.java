...
public class ArenaManagerUtils {
   ...
   * @author au5tie
   */
  public static Optional<ArenaManager> getManagerOfType(
    TobnetArena arena,
    ArenaManagerType type
  ) {
    return arena
      .getManagers()
      .stream()
   ...
   * @author au5tie
   */
  public static Optional<CustomArenaManager> getCustomManager(
    TobnetArena arena,
    String customType
  ) {
    return arena
  ...
  public static Optional<ArenaGameManager> getGameManager(TobnetArena arena) {
    Optional<ArenaManager> gameManager = getManagerOfType(
      arena,
      ArenaManagerType.GAME
    );
   ...
   * @author au5tie
   */
  public static Optional<ArenaPlayerManager> getPlayerManager(
    TobnetArena arena
  ) {
    Optional<ArenaManager> playerManager = getManagerOfType(
      arena,
      ArenaManagerType.PLAYER
    );
