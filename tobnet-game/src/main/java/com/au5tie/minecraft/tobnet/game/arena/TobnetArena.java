...
public abstract class TobnetArena {
     ...
     * all of the default managers and the implementing plugin can override each prepare() method to customize that specific
     * manager. After all of the main managers have been setup, then prepareAdditionalManagers() will be called where the
