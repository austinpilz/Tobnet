...
public final class ArenaTask {
    ...
    private void scheduleSynchronousDelayedTask() {
        ...
        taskId = Bukkit.getScheduler().scheduleSyncDelayedTask(TobnetGamePlugin.instance, getRunnable(), getInitialDelay());
    }
    ...
    private void scheduleSynchronousRecurringTask() {
        ...
        taskId = Bukkit.getScheduler().scheduleSyncRepeatingTask(TobnetGamePlugin.instance, getRunnable(), getInitialDelay(), getInterval());
    }
