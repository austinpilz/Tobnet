...
public class ArenaManagerTest {
   ...
   * @author au5tie
   */
  public void registerMockArenaManager(
    ArenaManager mockManager,
   ...
   * @author au5tie
   */
  public void completeMockArenaManagerRegistration(
    ArenaManager currentManager
  ) {
   ...
   * @author au5tie
   */
  public void registerArenaGameStatusMock(
    ArenaGameManager gameManager,
    ArenaGameStatus status
  ) {
