...
class GamePlayerDisplayManagerTest {
  ...
  void shouldTestBasicComponentRegistration() {
    MockGamePlayerDisplayComponent component =
      new MockGamePlayerDisplayComponent(
        "display1",
        5,
        player,
        GamePlayerDisplayComponentLocation.BOSS_BAR
      );
    ...
    assertEquals(
      component,
      displayManager.getComponent(component.getName()).orElse(null)
    );
  }
  ...
  void shouldTestDuplicateComponentRegistration() {
    ...
    MockGamePlayerDisplayComponent differentComponent =
      new MockGamePlayerDisplayComponent(
        "display1",
        5,
        player,
    ...
    try {
      ...
      fail(
        "The same unique component was registered twice which should not throw an error. The error is only applicable if two different components with the same name are registered."
      );
    }
  }
  ...
  void shouldTestDuplicateComponentRegistrationDifferentUnique() {
    ...
    Assertions.assertThrows(
      DuplicatePlayerDisplayComponentException.class,
      () -> {
  ...
  void shouldTestComponentDisplaySameLocation() {
    MockGamePlayerDisplayComponent highestPriorityComponent =
      new MockGamePlayerDisplayComponent(
        "display1",
        1,
        player,
    ...
    MockGamePlayerDisplayComponent mediumPriorityComponent =
      new MockGamePlayerDisplayComponent(
        "display2",
        5,
        player,
    ...
    MockGamePlayerDisplayComponent secondMediumPriorityComponent =
      new MockGamePlayerDisplayComponent(
        "display3",
        5,
        player,
    ...
    displayManager.requestComponentDisplay(
      secondMediumPriorityComponent.getName()
    );
  ...
  void shouldTestComponentDisplayDifferentLocations() {
    MockGamePlayerDisplayComponent bossBarHighestPriorityComponent =
      new MockGamePlayerDisplayComponent(
        "display1",
        1,
        player,
    ...
    displayManager.requestComponentDisplay(
      bossBarHighestPriorityComponent.getName()
    );

    MockGamePlayerDisplayComponent bossBarLowestPriorityComponent =
      new MockGamePlayerDisplayComponent(
        "display2",
        5,
        player,
    ...
    displayManager.requestComponentDisplay(
      bossBarLowestPriorityComponent.getName()
    );

    assertTrue(bossBarHighestPriorityComponent.isVisible());
    assertFalse(bossBarLowestPriorityComponent.isVisible());

    MockGamePlayerDisplayComponent actionBarHighestPriorityComponent =
      new MockGamePlayerDisplayComponent(
        "display3",
        1,
        player,
        GamePlayerDisplayComponentLocation.ACTION_BAR
      );
    displayManager.registerComponent(actionBarHighestPriorityComponent);
    displayManager.requestComponentDisplay(
      actionBarHighestPriorityComponent.getName()
    );
